"""
CookTalk Phase 3 — Client-Side Latency Benchmark Harness
...
Logs every trial without modification to client_perceived_results.jsonl.
"""
...
RESULTS_FILE = BENCH_DIR / "client_perceived_results.jsonl"
...
async def run_benchmark():
    print("=" * 70)
    print("CookTalk Phase 3 — Automated Client Latency Benchmark")
    print("=" * 70)
    ...
    if RESULTS_FILE.exists():
        RESULTS_FILE.unlink()
        print("Cleared previous client_perceived_results.jsonl")

    room_name = f"bench-matrix-session-{int(time.time())}"
    ...
    try:
        for round_num in range(1, 6):
            ...
            for q in QUESTIONS:
                ...
                # Cooldown between queries to let room and agent settle
